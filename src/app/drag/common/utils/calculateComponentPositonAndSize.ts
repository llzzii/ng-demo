...
function calculateLeftTop(
  ...
  if (newWidth > 0 && newHeight > 0) {
    ...
    style.x = Math.round(newTopLeftPoint.x);
    style.y = Math.round(newTopLeftPoint.y);
  }
  return style;
}
...
function calculateRightTop(
  ...
  if (newWidth > 0 && newHeight > 0) {
    style.width = Math.round(newWidth);
    style.height = Math.round(newHeight);
    style.x = Math.round(newBottomLeftPoint.x);
    style.y = Math.round(newTopRightPoint.y);
  }
  return style;
}
...
function calculateTop(
  ...
  if (newHeight > 0) {
    ...
    style.width = width;
    style.height = Math.round(newHeight);
    style.y = Math.round(newCenter.y - newHeight / 2);
    style.x = Math.round(newCenter.x - style.width / 2);
  }
  return style;
}
...
function calculateRight(
  ...
  if (newWidth > 0) {
    ...
    style.height = height;
    style.width = Math.round(newWidth);
    style.y = Math.round(newCenter.y - style.height / 2);
    style.x = Math.round(newCenter.x - newWidth / 2);
  }
  return style;
}
